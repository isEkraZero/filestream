...
const BOT_TOKEN = "7396671938:AAEEGfaZOGRvveNIEdYaHms8atltAsKSnZk"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = ""; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 7652024370; // Insert your telegram account id.
const BOT_CHANNEL = -1007396671938; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "hdiIsd8eie"; // Insert a powerful secret text and keep it safe.
